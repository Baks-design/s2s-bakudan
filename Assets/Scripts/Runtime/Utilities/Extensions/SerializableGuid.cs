...
namespace Game.Runtime.Utilities.Extensions
{
    ...
    {
        [SerializeField, HideInInspector] uint Part1;
        [SerializeField, HideInInspector] uint Part2;
        [SerializeField, HideInInspector] uint Part3;
        [SerializeField, HideInInspector] uint Part4;
